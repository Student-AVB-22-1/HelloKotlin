package com.example.lab5_4_art_space
...
import com.example.lab5_4_art_space.ui.theme.Lab5_4_Art_SpaceTheme
        ...
        DisplayController(
            onPreviousClick = {
                currentArtwork = when(currentArtwork) {
                    //Циклический переход(с первой фотки идем к 3-й)
                    1 -> 3
                    else -> currentArtwork - 1 //Обычный переход(если тыкнуть назад на второй фотке, то будет первая фотка)
                }
            },
            onNextClick = {
                currentArtwork = when(currentArtwork) {
                    //Циклический переход(с третьей фотки идем на первую)
                    3 -> 1
